...
// We can import API functions as well, for code-reusability and cleaner code
import { tellTheWorld } from '../api/myAPI'
...
class App extends Component {
  ...
  // Below are the 4 default functions that a React component calls upon mounting or updating
  // Use these by their appropriate names to trigger functions at the desired point in time

  // gets called just once, before the <App> is rendered
  componentWillMount(){
    tellTheWorld("Component is about to be mounted!")
  }

  // gets called just once, after the <App> has rendered
  componentDidMount(){
    tellTheWorld("Component was just mounted!")
  }

  // gets called right before <App> updates. unlike `componentWillMount()`, `componentWillUpdate()` gets called multiple times
  componentWillUpdate(){
    tellTheWorld("Component is about to update")
  }

  // gets called right after <App> updates
  componentDidUpdate(){
